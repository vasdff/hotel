...
<html lang="en">
<head>
	<title>xx民宿管理系统登录页面</title>
	<link
			href="../resources/home/css/index.css"
			type="text/css"
			rel="Stylesheet"
	/>
	<link
			href="../resources/home/css/login.css"
			type="text/css"
			rel="Stylesheet"
	/>
</head>
...
<header>
	<div>
		<a href="index.html"
		><img src="../resources/home/images/logo-1.jpg" alt=""
		/></a>
		<span>会员登录</span>
	</div>
</header>
	...
	<div class="login">
		<div id="normal">
			...
			<div class="codes" style="margin-top: 25px">
				...
				<img
						id="cpacha-img"
						src="../system/get_cpacha?vl=4&w=173&h=33&type=accountLoginCpacha"
						onclick="changeVcode()"
						class="code"
